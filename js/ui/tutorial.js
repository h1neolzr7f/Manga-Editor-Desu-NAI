...
'<div class="tutorial-prompt-title">语言选择</div>'+
'<div class="tutorial-prompt-body">已锁定为中文界面</div>'+
...
'<li>要自定义底图自己切格子：左侧「页面」→「自定义页面」，关掉空画布提示后点「切割格子」。</li>'+
'</ol>'+
...
{element:'#intro_page-manager-area',title:'④ 自定义切格子',body:'不想套模板时，到「页面」建自定义页面，再点「切割格子」。空画布提示可关掉，不会挡刀。',position:'right'}
];
