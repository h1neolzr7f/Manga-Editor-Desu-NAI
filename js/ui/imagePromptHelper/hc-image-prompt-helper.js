...
<button id="iph-copy-button" class="iph-icon-button" disabled data-i18n="[title]copy"><i class="material-icons">content_copy</i></button>
<button id="iph-download-button" class="iph-icon-button" disabled data-i18n="[title]download"><i class="material-icons">download</i></button>
<button id="iph-clear-button" class="iph-icon-button" disabled data-i18n="[title]iphClearAll"><i class="material-icons">delete</i></button>
</span>
</div>
<div class="iph-sel-list" id="iph-sel-list"></div>
<div class="iph-prompt-box" id="iph-prompt-box"></div>
<div class="iph-prompt-acts">
<button id="iph-prompt-copy" class="iph-icon-button" disabled data-i18n="[title]copy"><i class="material-icons">content_copy</i></button>
<button id="iph-prompt-download" class="iph-icon-button" disabled data-i18n="[title]download"><i class="material-icons">download</i></button>
</div>
