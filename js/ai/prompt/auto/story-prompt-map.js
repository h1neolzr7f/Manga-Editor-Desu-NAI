...
scenarioPromptMap.add('manga_story_rhythm',[100000,200000,300000,400000,420000,500000,510000,600000,700000,800000]);
...
var legacy=localStorage.getItem('ScenarioPromptSelecter');
if(legacy==='normal_sex'){
select.value='manga_story_rhythm';
}
}
