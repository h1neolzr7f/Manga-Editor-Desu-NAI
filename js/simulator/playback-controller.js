...
if(Array.isArray(value.comments))value.comments=value.comments.slice(0,index+1);
if(Array.isArray(value.danmaku))value.danmaku=value.danmaku.slice(0,index+1);
if(Array.isArray(value.replies))value.replies=value.replies.slice(0,index+1);
if(Array.isArray(value.posts))value.posts=value.posts.slice(0,index+1);
...
root.NaiComicPlaybackController={previous:previous,next:next,play:play,stop:stop,exportKeyframes:exportKeyframes,exportPages:insertPages,makeVisibleScene:makeVisibleScene};
