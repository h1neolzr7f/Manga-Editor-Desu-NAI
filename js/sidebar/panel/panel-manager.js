...
var scaleToFitX=frameBounds.width/obj.width;
var scaleToFitY=frameBounds.height/obj.height;
var scaleToFit=Math.max(scaleToFitX,scaleToFitY);
moveSettings(obj,targetFrame);
if(isFit){
obj.set({
left: frameCenterX-(obj.width*scaleToFit*1.02)/2,
top: frameCenterY-(obj.height*scaleToFit*1.02)/2,
scaleX: scaleToFit*1.02,
scaleY: scaleToFit*1.02,
});
}
if (obj.name) {
