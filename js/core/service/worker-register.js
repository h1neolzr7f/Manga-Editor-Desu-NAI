...
if (reg.scope&&(reg.scope.indexOf('/SP-MangaEditer/')!==-1||reg.scope!==new URL('./',window.location.href).href)) {
reg.unregister();
}
});
});
...
.register(new URL("service-worker.js",window.location.href).toString())
.then(function (reg) {
registration=reg;
